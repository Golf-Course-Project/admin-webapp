---
name: 'update-course-and-facility-from-csv'
description: 'This custom agent process the csv file provided and go thru it one row a time. It will then use the `golf course project` mcp server to update the course and facility information based on the data in the csv.'
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'golf-course-project/course_fetch', 'golf-course-project/course_update', 'golf-course-project/facility_fetch', 'golf-course-project/facility_update', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runSubagent']
---
...
### ⚠️ Do not update the longitude or latitude fields ⚠️
